...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cloud-sql-python-connector-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cloud-sql-python-connector-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cloud-sql-python-connector
# for installing globally
pixi global install cloud-sql-python-connector
```
...
It is possible to list all of the versions of `cloud-sql-python-connector` available on your platform:
...
```
pixi search cloud-sql-python-connector --channel conda-forge
```
